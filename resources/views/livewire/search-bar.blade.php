<div class="relative flex justify-center items-center mx-auto mt-8 md:w-1/2 lg:w-1/3 hover:text-gray-900 dark:hover:text-white">
        ...
        @if (!empty($users))
            <div class="absolute top-16 w-full">
                <div
                    ...
                    <div class="px-4 py-3 text-gray-900 dark:text-white hover:bg-gray-300 dark:hover:bg-gray-500 cursor-pointer">
                        {{ $users->links() }}
                    </div>
                </div>
            </div>
